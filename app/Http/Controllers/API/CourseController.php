...
class CourseController extends Controller
{
    ...
    public function allStudents($courseId)
    {
        ...
        if (!$course) {
            return response()->json([
                'message' => 'Course not found',
            ], 404);use Illuminate\Support\Facades\Log;

public function index()
{
    Log::info('Course index accessed');
...
public function store(Request $request)
{
    Log::info('Course store accessed');
...
public function update(Request $request, string $id)
{
    Log::info('Course update accessed');
...
public function destroy(string $id)
{
    Log::info('Course destroy accessed');
...
public function sections(string $id)
{
    Log::info('Course sections accessed');
...
public function lectures(string $id)
{
    Log::info('Course lectures accessed');
...
public function allStudents($courseId)
{
    Log::info('Course all students accessed');
...
{
    Log::info('Course add student to course accessed');
    ...
    if ($course->students()->where('student_id', $student->id)->exists()) {
        Log::warning('Student already enrolled in this course');
    ...
    Log::info('Student added to course and lectures successfully');
...
{
    Log::info('Course add student to sections accessed');
    ...
    if (!$course->students()->where('student_id', $student->id)->exists()) {
        Log::warning('Student is not enrolled in this course');
    ...
    Log::info('Student added to all sections in the course successfully');
...
{
    Log::info('Course my courses accessed');
    ...
    Log::warning('No courses found for this user.');
